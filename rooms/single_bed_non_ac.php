...
<body>
    ...
    <div class="container pt-100">
        <div class="row">
            <div class="col-sm">
                <center>
                    <img src="./../img/card_single_bed_non_ac.jpg" style="width:90%; height:400px; object-fit:cover; border-radius: 8px; border: 5px solid #ddd; box-shadow: 0px 1px 8px 0px #888888;">
                    <hr>
